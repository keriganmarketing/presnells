    	...
    	<div class="container">
            <div class="bot-bot-container">
            	<div id="social-media-icons" class="col-md-3">
                    ...
                    <!--<a href="#" target="_blank" ><img src="<?php echo get_template_directory_uri() ?>/img/ta-icon.png" alt="Review us on TripAdvisor" /></a>-->
                ...
                <div class="copyright col-md-6" >
            		<p>&copy;<?php echo date('Y'); ?> Presnell's Vacation Resort & RV Park, LLC. All rights reserved.</p>
                </div>
