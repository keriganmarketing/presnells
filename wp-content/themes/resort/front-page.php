...
<div id="cta-bar" class="bg-accent py-3 py-md-4 py-lg-5 text-center d-flex justify-content-center flex-wrap">
    <div class="p-2 px-md-3" ><a href="#" class="btn btn-white bitter btn-lg">Book Online</a></div>
    <div class="p-2 px-md-3" ><a href="#" class="btn btn-white bitter btn-lg">RV Site Rates</a></div>
</div>
